...
window.TRANSLATIONS = {
    en: {
        ...
        petrifiedBarkHint: "Bark splits and peels in layers.",
        ...
        reliquaryOpenHint: "The chains fell away - smash the chest open.",
        ...
        quartzHint: "quartz - fragile crystal prisms. Shatters when struck.",
    ...
    es: {
        ...
        petrifiedBarkHint: "La corteza se divide y se desprende en capas.",
        ...
        reliquaryOpenHint: "Las cadenas cayeron: abre el cofre a golpes.",
        ...
        quartzHint: "cuarzo - prismas de cristal frágiles. Se rompen al ser golpeados.",
        greatCube: "GRAN CUBO",
    ...
    fr: {
        ...
        petrifiedBarkHint: "L'écorce se fend et s'arrache en couches.",
        ...
        reliquaryOpenHint: "Les chaînes sont tombées : brisez le coffre.",
        ...
        quartzHint: "quartz - prismes de cristal fragiles. Se brisent quand on les frappe.",
    ...
    ar: {
        ...
        petrifiedBarkHint: "اللحاء ينشق ويتقشر في طبقات.",
        ...
        reliquaryOpenHint: "سقطت السلاسل - حطّم الصندوق وافتحه.",
        fallenStar: "نجم ساقط",
        ...
        quartzHint: "الكوارتز - موشورات بلورية هشة. تتحطم عند ضربها.",
    ...
    hi: {
        ...
        petrifiedBarkHint: "छाल परतों में फटती और छिलती है।",
        ...
        reliquaryOpenHint: "जंजीरें गिर गईं - संदूक तोड़कर खोलें।",
        ...
        quartzHint: "क्वार्ट्ज - नाजुक क्रिस्टल प्रिज्म। प्रहार करने पर चकनाचूर हो जाते हैं।",
        greatCube: "महान घन",
    ...
    ja: {
        ...
        petrifiedBarkHint: "樹皮は層になって割れ、剥がれる。",
        ...
        reliquaryOpenHint: "鎖が外れた - 宝箱を叩き割ろう。",
        fallenStar: "落ちた星",
        wonStarDimmed: "星光消滅",
        ...
        quartzHint: "クォーツ - 壊れやすいクリスタル柱。叩くと砕ける。",
        greatCube: "グレートキューブ",
    ...
    ru: {
        ...
        petrifiedBarkHint: "Кора трескается и отслаивается слоями.",
        ...
        reliquaryOpenHint: "Цепи упали — разбейте сундук.",
        ...
        quartzHint: "кварц - хрупкие кристаллы. Рассыпаются от удара.",
...
window.I18N = Object.freeze({
    ...
    levelNameKeys: Object.freeze([
        ...
        'honeycombHive', 'quartzCluster', 'chainReliquary', 'fallenStar', 'dragonEgg', 'greatCube'
    ]),
    levelWinKeys: Object.freeze([
        ...
        'wonHiveBroken', 'wonQuartzShattered', 'wonReliquaryOpened', 'wonStarDimmed', 'wonEggPlundered', 'wonGreatCubeCracked'
    ])
});
